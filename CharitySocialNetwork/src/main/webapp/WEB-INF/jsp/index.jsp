        ...
        <div class="theme-layout">
            <div class="responsive-header">
                <div class="mh-head first Sticky">
                    ...
                    <span class="mh-text">
                        <a href="newsfeed.html" title=""><img src="<c:url value="images/logo2.png"/>" alt=""></a>
                    </span>
            ...
            <div class="topbar stick">
                ...
                <div class="top-area">
                    ...
                    <ul class="setting-area">
                        ...
                        <li><a href="newsfeed.html" title="Home" data-ripple=""><i class="icon-home"></i></a></li>
                        <li>
                    ...
                    <div class="user-img">
                        ...
                        <div class="user-setting">
                            ...
                            <a href="<c:url value="/logout"/>" title=""><i class="ti-power-off"></i>Log out</a>
                        </div>
                    </div>
                                            ...
                                            <div class="widget">
                                                ...
                                                <ul class="naves">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="<c:url value="/login.jsp"/>" title="">Logout</a>
                                                    </li>
                                                </ul>
                                            </div><!-- Shortcuts -->
                                            <div class="widget">
