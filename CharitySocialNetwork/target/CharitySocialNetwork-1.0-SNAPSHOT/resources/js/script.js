...
//----- count down timer		
    ...
    jQuery(".post-comt-box textarea").on("keydown", function (event) {
        ...
        if (event.keyCode == 13 && document.getElementById("contentComment").value != "") {
             fetch("/CharitySocialNetwork/api/addComment", {
                method: 'post',
                body: JSON.stringify({
                    "contentComment": document.getElementById("contentComment").value,
                    "postId": 1,
                    "userId": 1
                }),
                headers: {
...
function addComment(postId, userId) {
    ...
    fetch("/CharitySocialNetwork/api/addComment", {
        ...
        console.info(data);
        let area = document.getElementById("comentarea");
        area.innerHTML = `<div class="comet-avatar">
                                        <img class ="avatar-header" src="#" alt="">
                                    </div>
