...
<div class="topbar stick">
    ...
    <div class="top-area">
        ...
        <div class="user-img">
            <c:if test="${currentUser.images == null ||currentUser.images.equals('') ==false}">
                <img class="avatar-header" src="${currentUser.images}" alt="">
            </c:if>
            <c:if test="${currentUser.images == null ||currentUser.images.equals('')}">
                <img class="avatar-header"  src="images/resources/default.png" alt="">
            </c:if>
